...
size_t dispatch_get_probes(dispatcher *self);
size_t dispatch_get_work(dispatcher *self);
...
size_t dispatch_get_probes_sub(dispatcher *self);
size_t dispatch_get_work_sub(dispatcher *self);
